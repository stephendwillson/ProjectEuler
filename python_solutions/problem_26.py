...
def main():
    ...
    # problem only asks for numerator == 1 but in theory should work with any num / denom
    for num in range(1, 2):
        for denom in range(1, denom_ceiling):
            ...
            # keep track of numerator, denominator, and length of cycle for longest found so far
